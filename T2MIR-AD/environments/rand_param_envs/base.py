# from environments.rand_param_envs.gym.core import Env
# from environments.rand_param_envs.gym.envs.mujoco import MujocoEnv
...
class RandomEnv(MetaEnv, MujocoEnv):
    ...
    def __init__(self, log_scale_limit, file_name, *args, rand_params=RAND_PARAMS, **kwargs):
        MujocoEnv.__init__(self, file_name, 4, observation_space=kwargs['observation_space'])
